...
namespace DatabaseManageBar
{
    public class DataBaseOperate
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static string getChartPlotId(string name)
        {
            string strsql = "select PlotID from PLOT_DKINFO where FULLNAME=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        public static string getCountyCode(string name)
        {
            string strsql = "select QXCode from COUNTY where CountyName=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        {
            string strsql = "select CountyName from COUNTY where QXCode=@code";
            SqlParameter param = new SqlParameter("code", code);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        /// <returns></returns>
        public static string get_PlotName(string plotid)
        {
            string strsql = "select FULLNAME from PLOT_DKINFO where PlotID=@plotid";
            SqlParameter param = new SqlParameter("@plotid", plotid);
            string result = getResult(strsql, param);
            return result;
        ...
        /// <param name="plotid"></param>
        /// <returns></returns>
        public static string get_PlotCodeName(string plotname)
        {
            string strsql = "select PlotID from PLOT_DKINFO where FULLNAME=@plotname";
            SqlParameter param = new SqlParameter("@plotname", plotname);
            string result = getResult(strsql, param);
            return result;
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static string get_NutrientCHName(string code)
        {
            string strsql = "select [NUTRIENT_NAME] from SOILNUTRIENT_CODE where NUTRIENT_CODE=@code";
            SqlParameter param = new SqlParameter("@code", code);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static string get_ProCode(string name)
        {
            string strsql = "SELECT [ProCode] FROM [PROVINCE] where [ProvinceName]=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static string get_SHICode(string name)
        {
            string strsql = "SELECT [SHICode] FROM [CITY] where [CityName]=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static string get_QXCode(string name)
        {
            string strsql = "SELECT [QXCode] FROM [COUNTY] where [CountyName]=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
